...
export const STRINGS = {
  en: {
    ...
    credits2:
      'Samples: <a href="https://github.com/gleitz/midi-js-soundfonts" rel="noopener">MusyngKite soundfont kit (CC BY-SA 3.0)</a> and the Splendid Grand Piano via <a href="https://github.com/danigb/smplr" rel="noopener">smplr (MIT)</a> · scheduling by <a href="https://tonejs.github.io/" rel="noopener">Tone.js (MIT)</a> · drums synthesized in-browser. This site is <a href="https://github.com/HaKexva/the-woodshed" rel="noopener">open source under GPLv3</a>. For personal practice &amp; education.',
    tempo: "tempo",
    band: "band",
    play: "play",
    stop: "stop",
  ...
  zh: {
    ...
    credits2:
      '取樣音色：<a href="https://github.com/gleitz/midi-js-soundfonts" rel="noopener">MusyngKite soundfont（CC BY-SA 3.0）</a>與 Splendid Grand Piano，經由 <a href="https://github.com/danigb/smplr" rel="noopener">smplr（MIT）</a>播放 · 排程由 <a href="https://tonejs.github.io/" rel="noopener">Tone.js（MIT）</a>驅動 · 鼓組為瀏覽器內合成。本站以 <a href="https://github.com/HaKexva/the-woodshed" rel="noopener">GPLv3 開源</a>。僅供個人練習與教育用途。',
    tempo: "速度",
    band: "樂隊",
    play: "播放",
    stop: "停止",
