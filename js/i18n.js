...
export const STRINGS = {
  en: {
    ...
    "err.notJson": "that is not JSON",
    "err.noTunes": "no tunes in there",
    "ed.warning":
    ...
    "ed.close": "close",
    "ed.importLabel": "paste a tune to edit it, or a whole collection to add it",
    "ed.load": "load json",
    "ed.copy": "copy",
    "ed.copied": "copied",
  ...
  zh: {
    ...
    "ed.random": "隨機和弦",
    "ed.close": "關閉",
    "ed.importLabel": "貼上單首樂曲可載入編輯，貼上整份收藏則會匯入",
    "ed.load": "載入 JSON",
    "ed.copy": "複製",
    "ed.copied": "已複製",
