...
export const STRINGS = {
  en: {
    ...
    tradeSub: "fours",
    tradeFours: "fours",
    tradeBand: "band's four",
    tradeYou: "your four",
    countK: "choruses",
    countSub: "then stop",
    chorusK: "chorus",
    readingSub: "what you read",
    ...
    "mute.drums": "drums",
    boost: "Bass+",
    boostTip: "For phone and laptop speakers only. Leave it off on headphones.",
    reading: "reading",
    readC: "C",
    comp: "comp",
    compPlain: "plain",
    ...
    newTune: "new",
    "ed.save": "save & play",
    "ed.update": "update & play",
    "ed.delete": "delete",
    "ed.titlePh": "untitled",
    "ed.sheetEmpty": "the chart appears as you type",
    "ed.shape": "{bars} bars · {ts}",
    "ed.reads": "reads",
