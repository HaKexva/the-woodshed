# HQ sample pack credits

All samples CC0 1.0 (public domain dedication). Vendored as mono 96 kbps AAC
subsets of the original libraries; see `manifest.json` for the exact mapping.
...
Processing: transcode to mono AAC, leading-silence trim (bass), 4 s fade-out
on ride, bell and sweep tails.
